#undef ZOMBIESHOOTERANYCODE_API
...
#define UE_PROJECT_NAME ZombieShooterAnyCode
#define UE_TARGET_NAME ZombieShooterAnyCodeEditor
...
#define ZOMBIESHOOTERANYCODE_API DLLEXPORT
